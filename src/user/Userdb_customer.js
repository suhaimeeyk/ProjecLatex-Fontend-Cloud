...
export default function Users() {
  ...
  const filteredData = items.data?.filter((data, index) => {
    const customer_name = data.customer_name.toLowerCase();
    const customer_tel = data.customer_tel.toLowerCase();
    const catusers_name = data.catusers_name.toLowerCase();
    const users_name = data.users_name.toLowerCase();

    return (
      customer_name.includes(searchQuery.toLowerCase()) ||
      customer_tel.includes(searchQuery.toLowerCase()) ||
      catusers_name.includes(searchQuery.toLowerCase()) ||
