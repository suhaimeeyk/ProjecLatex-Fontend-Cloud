...
export default function SignUp() {
    ...
    //     fetch("https://latexplatform-api.coecore.com/db_manure_detail/", requestOptions)
    //         .then(res => res.json())
    //         .then((result) => {
    //             setItems(result);
    //             // console.log(result)
    ...
    useEffect(() => {
        ...
        fetch("https://latexplatform-api.coecore.com/db_manure_detail/" + users_id, requestOptions)
            .then(res => res.json())
            .then((result) => {
                setItems(result);
                console.log(result)
    ...
    useEffect(() => {
        ...
        fetch("https://latexplatform-api.coecore.com/db_reveal_detail/" + users_id, requestOptions)
            .then(res => res.json())
            .then((result) => {
                setUsers(result);
                console.log(result)
    ...
    // const UserGetUsers = () => {
    //     fetch("https://latexplatform-api.coecore.com/db_reveal_detail")
    //         .then(res => res.json())
    //         .then(
    //             (result) => {
    //                 setUsers(result);
    ...
    const handleSubmit = (event) => {
        ...
        if ((jsonData.Manuredb_income && jsonData.Revealdb_income && jsonData.pay_for_all_latex_db_income && jsonData.pay_for_all_latex_db_income && jsonData.note && jsonData.total_price) === '') {
            ...
            fetch('https://latexplatform-api.coecore.com/Createdatadb_income', {
                method: 'POST', // or 'PUT'
                headers: {
                    'Content-Type': 'application/json',
                },
                ...
                >
                    ...
                    />
                        ...
                        <Grid container justifyContent="flex-end">
                            <Grid item>
                                <Link href="/user/ProfitUser" variant="body2">
                                    BACK
                                </Link>
                            </Grid>
                        </Grid>
