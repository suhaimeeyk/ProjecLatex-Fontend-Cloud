        ...
        fetch('https://latexplatform-api.coecore.com/authen', {
            ...
            .then((data) => {
                if (data.status === 'ok') {
                    ...
                    //   console.log(data.decoded['customer_id'])
        ...
        fetch('https://latexplatform-api.coecore.com/authen', {
            ...
            .then((data) => {
                if (data.status === 'ok') {
                    ...
                    setusers_name(data.decoded['customer_name'])
                    console.log(data.decoded['customer_id'])
                    ...
                    <Container>
                        ...
                        <Grid container spacing={2}>
                                ...
                                <Item>
                                    ...
                                    <ResponsiveContainer width="100%" aspect={2}>
                                        ...
                                        >
                                            ...
                                            <YAxis dataKey="ยอดเงินสะสมของเจ้าของสวน" />
                                            <Bar dataKey="ยอดเงินสะสมของเจ้าของสวน" fill="#8884d8" shape={<TriangleBar />} label={{ position: 'top' }}>
                            ...
                            <Grid item xs={12} sm={12}>
                                <Item>
                                    <Typography variant="h6" gutterBottom >
                                        กราฟแสดงรายละเอียดทั้งหมดของเจ้าของสวน
                                    </Typography>
                                    <ResponsiveContainer width="100%" aspect={2}>
                                        <ComposedChart width={300} height={100} data={db_dataALL}>

                                            <XAxis dataKey="data_date" stackId="a"  />
                                            ...
                                            <Legend />
                                            <Area label="" type="monotone" dataKey="ผู้ตัดยาง" fill="#8884d8" stroke="#8884d8" />
                                            {/* <XAxis dataKey="ผู้ตัดยาง"  stackId="a"  /> */}

                                             <Bar dataKey="จำนวนเงินทั้งหมด" stackId="a"  fill="#FF0000" />
                                            <Bar dataKey="เงินส่วนเจ้าของสวน" stackId="b" barSize={20} fill="#4600FF" />
                                            {/* <Bar dataKey="น้ำหนักรวมทั้งหมด" stackId="b" barSize={20} fill="#4600FF" />
                                            <Bar dataKey="น้ำหนักแกลลอน" stackId="c" barSize={20} fill="#006CFF" />
                                            <Bar dataKey="น้ำหนักหักลบแกลลอน" stackId="d" barSize={20} fill="#01A62E" />
                                            <Bar dataKey="น้ำยาแห้ง" stackId="e" barSize={20} fill="#A69701" />
                                            <Bar dataKey="เปอร์เซ็น" stackId="f" barSize={20} fill="#A65401" />  */}
                                            <Bar dataKey="เงินส่วนคนตัด" stackId="f" barSize={20} fill="#A65401" />
