...
export default function Users() {
    ...
    useEffect(() => {
        ...
        fetch("https://latexplatform-api.coecore.com/RevealdisplayAllCos/" + users_id, requestOptions)
            .then(res => res.json())
            .then((result) => {
                setItems(result);
                console.log(result)
    ...
    //     fetch("https://latexplatform-api.coecore.com/Revealdisplay", requestOptions)
    //         .then(res => res.json())
    //         .then((result) => {
    //             setItems(result);
    //             console.log(result);
    ...
    const Process_owner = reveal_id => {
        window.location = '/Owner/Revealdisplay_detailUser/' + reveal_id
    }
    const Process_divide = reveal_id => {
        window.location = '/Owner/RevealditformUser/' + reveal_id
    }
    ...
    const UserDelete = reveal_id => {
        ...
        fetch("https://latexplatform-api.coecore.com/db_reveal_id", requestOptions)
            ...
            .then((data) => {
                console.log(data)
                if (data.status === 'Ok') {
                    window.location = '/Owner/RevealdisplayUser'
