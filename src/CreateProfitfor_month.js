                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} >
                                ...
                                <FormControl fullWidth>
                                    <InputLabel name="income" id="income">ผลร่วมรายการรับต่อเดือน</InputLabel>

                                    <Select
                                        labelId="demo-simple-select-label"
                                        id="income"
                                        label="ผลร่วมรายการรับต่อเดือน"
                                        name="income"
                                    ...
                                    >
                                        ...
                                        {items.data?.map((data, index) => (
                                            ...
                                            <MenuItem value={data.total_profit}>เดือน {data.month} จำนวนเงิน {data.total_profit}</MenuItem>
                                        ))}
                            ...
                            <Grid item xs={12}  >
                                <FormControl fullWidth>
                                    <InputLabel name="paydaily" id="paydaily">ผลร่วมรายการเบิกล่วงหน้าต่อเดือน</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-label"
                                        id="paydaily"
                                        label="ผลร่วมรายการเบิกล่วงหน้าต่อเดือน"
                                        name="paydaily"
                                        onChange={fncSum} aria-describedby="emailHelp" placeholder=""
